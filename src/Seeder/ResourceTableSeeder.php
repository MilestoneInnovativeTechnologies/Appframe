...
class ResourceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\Resource::truncate()
            ...
            ->create([	'name' => 'ResourceAction', 	'description' => 'Actions applicable for the resource', 	'title' => 'Resource Actions', 	'namespace' => 'Milestone\Appframe\Model', 	'table' => '__resource_actions', 	'key' => 'id', 	'controller' => 'ResourceActionController', 	'controller_namespace' => 'Milestone\Appframe\Controllers', 								])
            ...
            ->create([	'name' => 'ResourceFormFieldDepend', 	'description' => 'Dependent fields in a form', 	'title' => 'Dependent Fields', 	'namespace' => 'Milestone\Appframe\Model', 	'table' => '__resource_form_field_depends', 	'key' => 'id', 	'controller' => 'ResourceFormFieldDependController', 	'controller_namespace' => 'Milestone\Appframe\Controllers', 								])
