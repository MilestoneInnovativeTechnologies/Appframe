...
class ResourceRelationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceRelation::truncate()
            ...
            ->create([	'id' => '24', 	'resource' => '19', 	'name' => 'Default Data Relation', 	'description' => 'Relation to which the forms predefined data to be bind', 	'method' => 'Relation', 	'type' => 'belongsTo', 	'relate_resource' => '6', 									])
