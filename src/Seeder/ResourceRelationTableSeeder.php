...
class ResourceRelationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceRelation::truncate()
            ...
            ->create([	'resource' => '32', 	'name' => 'Dependent Field', 	'description' => 'Details of field to which this dependent record belongs to', 	'method' => 'Field', 	'type' => 'belongsTo', 	'relate_resource' => '13', 										])
        ;
