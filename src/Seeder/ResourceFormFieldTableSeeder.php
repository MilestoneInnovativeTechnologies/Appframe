...
class ResourceFormFieldTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormField::truncate()
            ...
            ->create([	'id' => '52', 	'resource_form' => '10', 	'name' => 'identity', 	'type' => 'text', 	'label' => 'Field name to identify selected item', 											])
            ->create([	'id' => '53', 	'resource_form' => '10', 	'name' => 'items_per_page', 	'type' => 'text', 	'label' => 'Items to display per page', 											])
            ->create([	'id' => '54', 	'resource_form' => '10', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '55', 	'resource_form' => '11', 	'name' => 'resource', 	'type' => 'text', 	'label' => 'Resource', 											])
            ->create([	'id' => '56', 	'resource_form' => '11', 	'name' => 'name', 	'type' => 'text', 	'label' => 'List Name', 											])
            ->create([	'id' => '57', 	'resource_form' => '11', 	'name' => 'title', 	'type' => 'text', 	'label' => 'Title', 											])
            ->create([	'id' => '58', 	'resource_form' => '11', 	'name' => 'identity', 	'type' => 'text', 	'label' => 'Field name to identify selected item', 											])
            ->create([	'id' => '59', 	'resource_form' => '11', 	'name' => 'items_per_page', 	'type' => 'text', 	'label' => 'Items to display per page', 											])
            ->create([	'id' => '60', 	'resource_form' => '11', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '61', 	'resource_form' => '12', 	'name' => 'resource', 	'type' => 'select', 	'label' => 'Select Resource', 											])
            ->create([	'id' => '62', 	'resource_form' => '12', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '63', 	'resource_form' => '12', 	'name' => 'title_field', 	'type' => 'text', 	'label' => 'Title Field', 											])
            ->create([	'id' => '64', 	'resource_form' => '12', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '65', 	'resource_form' => '13', 	'name' => 'resource', 	'type' => 'text', 	'label' => 'Resource', 											])
            ->create([	'id' => '66', 	'resource_form' => '13', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '67', 	'resource_form' => '13', 	'name' => 'title_field', 	'type' => 'text', 	'label' => 'Title Field', 											])
            ->create([	'id' => '68', 	'resource_form' => '13', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '69', 	'resource_form' => '14', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '70', 	'resource_form' => '14', 	'name' => 'title', 	'type' => 'text', 	'label' => 'Title', 											])
            ->create([	'id' => '71', 	'resource_form' => '14', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '72', 	'resource_form' => '15', 	'name' => 'name', 	'type' => 'text', 	'label' => 'Name', 											])
            ->create([	'id' => '73', 	'resource_form' => '15', 	'name' => 'title', 	'type' => 'text', 	'label' => 'Title', 											])
            ->create([	'id' => '74', 	'resource_form' => '15', 	'name' => 'description', 	'type' => 'textarea', 	'label' => 'Description', 											])
            ->create([	'id' => '75', 	'resource_form' => '16', 	'name' => 'role', 	'type' => 'select', 	'label' => 'Select Role', 											])
            ->create([	'id' => '76', 	'resource_form' => '16', 	'name' => 'resource', 	'type' => 'select', 	'label' => 'Select Resource', 											])
            ->create([	'id' => '77', 	'resource_form' => '16', 	'name' => 'actions_availability', 	'type' => 'select', 	'label' => 'Actions Availability', 											])
            ->create([	'id' => '78', 	'resource_form' => '16', 	'name' => 'actions', 	'type' => 'multiselect', 	'label' => 'Select Actions', 											])
        ;
