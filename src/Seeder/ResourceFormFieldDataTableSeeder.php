...
class ResourceFormFieldDataTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceFormFieldData::truncate()
            ...
            ->create([	'id' => '52', 	'form_field' => '52', 	'attribute' => 'items_per_page', 													])
            ->create([	'id' => '53', 	'form_field' => '53', 	'attribute' => 'description', 													])
            ->create([	'id' => '54', 	'form_field' => '54', 	'attribute' => 'resource', 													])
            ->create([	'id' => '55', 	'form_field' => '55', 	'attribute' => 'name', 													])
            ->create([	'id' => '56', 	'form_field' => '56', 	'attribute' => 'title', 													])
            ->create([	'id' => '57', 	'form_field' => '57', 	'attribute' => 'items_per_page', 													])
            ->create([	'id' => '58', 	'form_field' => '58', 	'attribute' => 'description', 													])
            ->create([	'id' => '59', 	'form_field' => '59', 	'attribute' => 'resource', 													])
            ->create([	'id' => '60', 	'form_field' => '60', 	'attribute' => 'name', 													])
            ->create([	'id' => '61', 	'form_field' => '61', 	'attribute' => 'title_field', 													])
            ...
            ->create([	'id' => '65', 	'form_field' => '65', 	'attribute' => 'title_field', 													])
            ->create([	'id' => '66', 	'form_field' => '66', 	'attribute' => 'description', 													])
            ->create([	'id' => '67', 	'form_field' => '67', 	'attribute' => 'name', 													])
            ->create([	'id' => '68', 	'form_field' => '68', 	'attribute' => 'title', 													])
            ->create([	'id' => '69', 	'form_field' => '69', 	'attribute' => 'description', 													])
            ->create([	'id' => '70', 	'form_field' => '70', 	'attribute' => 'name', 													])
            ->create([	'id' => '71', 	'form_field' => '71', 	'attribute' => 'title', 													])
            ->create([	'id' => '72', 	'form_field' => '72', 	'attribute' => 'description', 													])
            ->create([	'id' => '73', 	'form_field' => '73', 	'attribute' => 'role', 													])
            ->create([	'id' => '74', 	'form_field' => '74', 	'attribute' => 'resource', 													])
            ->create([	'id' => '75', 	'form_field' => '75', 	'attribute' => 'actions_availability', 													])
            ->create([	'id' => '76', 	'form_field' => '76', 	'attribute' => 'actions', 													])
        ;
